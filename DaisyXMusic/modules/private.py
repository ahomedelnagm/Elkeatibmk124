...
def _start(client, message):
    client.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            [
               InlineKeyboardButton("- ♫︎༆𝙈𝙐𝙎𝙄𝘾༆♫︎ ›", url=f"https://t.me/{UPDATES_CHANNEL}"),
               InlineKeyboardButton("مبرمج السورس 💌", url=f"https://t.me/{SUPPORT_GROUP}")
            ],
            [
               InlineKeyboardButton("♫︎༆𝙈𝙐𝙎𝙄𝘾_𝙀𝙇𝙆𝙀𝘼𝙏𝙄𝘽༆♫︎", url=f"https://t.me/MusicElkeatib")
           ]]
        ),
...
async def gstart(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("💬 المبرمج", url=f"https://t.me/{SUPPORT_GROUP}")]])
    )
...
def map(pos):
    if pos == 1:
        ...
        button = [[
                  ...
                  [
                    InlineKeyboardButton(text="- ♫︎༆𝙈𝙐𝙎𝙄𝘾༆♫︎ ›", url=f"https://t.me/{UPDATES_CHANNEL}"),
                    InlineKeyboardButton(text="مبرمج السورس 💌", url=f"https://t.me/{SUPPORT_GROUP}")
                  ],
                  [
