...
- دعم قائمة التشغيل
- دعم التشغيل الحالي
- إظهار أسماء المسار عند التخطي
- صفر تعطل ، مستقر بالكامل
- دعم تشغيل Deezer و Youtube و Saavn
- لوحة الإعدادات
- التحكم بالأزرار
- الانضمام التلقائي لبرنامج Userbot
- قناة تشغيل الموسيقى
- دعم اختيار لوحة المفاتيح للعب يوتيوب
## 🚀 Deployment
...
$ git clone https://github.com/AMRR-DEV/Amr
$ cd DaisyXMusic
# Upgrade sources
